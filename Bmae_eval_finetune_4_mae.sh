...
# 创建输出目录
mkdir -p output_dir/bootstrapped_mae_finetune/4_mae
...
python main_finetune.py \
    ...
    --nb_classes 10 \
    --output_dir ./output_dir/bootstrapped_mae_finetune/4_mae \
    --log_dir ./output_dir/bootstrapped_mae_finetune/4_mae \
