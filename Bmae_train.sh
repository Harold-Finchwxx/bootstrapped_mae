...
python main_bootstrapped_pretrain.py \
    ...
    --blr 1e-3 \
    --weight_decay 0.05 \
    --output_dir ./output_dir/bootstrapped_mae/mae_0 \
    --log_dir ./output_dir/bootstrapped_mae/mae_0 \
...
python main_bootstrapped_pretrain.py \
    ...
    --data_path ./data/cifar10 \
    --prev_mae_path ./output_dir/bootstrapped_mae/mae_0/checkpoint-99.pth 